...
import { ENABLE_SECURE_COOKIE, SIGN_IN_ATTEMPT_EMAIL_COOKIE } from '@/lib/auth/utils';
...
export async function middleware(req: NextRequest) {
  ...
  // We can't rely on NODE_ENV in the preview environment so we use the ENABLE_SECURE_COOKIE environment variable
  const sessionData = await getCookieCache<Session>(req, { isSecure: ENABLE_SECURE_COOKIE });
