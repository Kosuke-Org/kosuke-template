export interface Technology {
  ...
  logoPath: string;
  url: string;
  category: 'frontend' | 'backend' | 'database' | 'auth' | 'deployment' | 'monitoring' | 'testing' | 'styling' | 'email';
}
...
export const getFeaturedTechnologies = () => {
  return technologies.filter(tech => 
    ['Next.js 15', 'React 19', 'TypeScript', 'Tailwind CSS', 'Shadcn/ui', 'Clerk'].includes(tech.name)
  );
};
